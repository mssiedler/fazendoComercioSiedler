...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findFilter", query = "SELECT c FROM Cliente c WHERE CAST(c.codigo VARCHAR(50)) like :filtro "
                                                                                   + "or c.nome like :filtro "
                                                                                   + "or c.email like :filtro "
                                                                                   + "or c.estado like :filtro "
                                                                                   + "or c.cep like :filtro "
                                                                                   + "or c.cidade like :filtro ")})
